...
class FCM {
    ...
    public function send_notification($registatoin_ids, $data) {
        ...
        $image = $protocol_type.$_SERVER['SERVER_NAME'] . dirname($_SERVER['REQUEST_URI']).'/upload/notification/'.$data['image'];
        //$image = $protocol_type.'10.0.2.2/the_stream/upload/notification/'.$data['image'];
